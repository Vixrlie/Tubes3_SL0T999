...
\begin{center}
    ...
    \begin{tabularx}{\linewidth}{C{0.7cm} X C{1.0cm} C{1.0cm}}
        ...
        3           & Regex meng-handle format \textless kata\textgreater\textless angka\textgreater dan berbagai edge case                            & \checkmark  &                \\
        4           & Pencarian KMP \& BM membaca `keywords.txt` secara iteratif dan tidak menggunakan built-in search function atau library eksternal & \checkmark  &                \\
        ...
        9           & \textbf{[Bonus]} Membuat Video YouTube                                                                                           &             & \checkmark     \\
        10          & \textbf{[Bonus]} Implementasi Algoritma Aho-Corasick dan Rabin-Karp                                                              & \checkmark  &                \\
        11          & \textbf{[Bonus]} Implementasi Censorship / Blur Teks dengan toggle on/off                                                        & \checkmark  &                \\
        12          & \textbf{[Bonus]} Implementasi Optical Character Recognition pada Gambar                                                          & \checkmark  &                \\
        \bottomrule
    \end{tabularx}
\end{center}
